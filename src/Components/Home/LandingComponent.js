                ...
                <div className="mx-auto" style={contentMaxWidth}>
                    <div className={'ml-16 md:ml-32'} >
                        ...
                        <div className={'flex justify-center ml-10 '}>
                            <div className={'relative right-28 text-justify font-Kanit uppercase text-light text-s '}
                                ...
                                <div className={'bg-light flex justify-end l:ml-0 md:ml-32'} style={{...styles.divider, ...styles.opacity_08}}/>
                            </div>
                        </div>
                    </div>
                    <div className={'flex relative bottom-5 l:ml-0 md:ml-32'} >
                        {userSource.map((source) => {
                            if (source?.hoverText) {
                                return (<ClipboardWithTooltip key={source?.name.toString()} title={source.name}/>);
                            }
                            return (
