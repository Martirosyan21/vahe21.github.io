...
const AboutComponent = ({}, ref)=>{
    return(
        <div ref={ref} className="w-full  bg-about-background bg-cover bg-no-repeat pb-36 ">
            ...
            <div className={'flex  justify-center '} >
                <div className={'w-96 mr-24 self-end'} >
                    <UnorderedList list={leftSectionPoints} className={'list-disc list-inside'} itemClassNem={'pb-5 font-Kanit text-s text-dark'}/>
                </div>
                <MainText text={`it's about understanding what makes users tick and building designs that speak to their hearts.`} className="w-fit mr-10 self-end max-w-96">
                    ...
                    <UnorderedList list={rightSectionPoints} className={'list-disc list-inside pt-20'} itemClassNem={'pb-7 font-Kanit text-s text-dark'}/>
                </MainText>
            </div>
        </div>
    )
